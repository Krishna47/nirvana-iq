...
| [v8_agentic_rag](pipelines/v8_agentic_rag/) | Retrieve → check → re-retrieve | Runnable |
...
Evolution Lab supports **true multi-turn** on runnable versions (v1–v8):
...
1. Fill [evaluation/scorecard.md](evaluation/scorecard.md) for v1–v8 after full evals
2. Climb the ladder: v9 multimodal / v10 self-RAG
